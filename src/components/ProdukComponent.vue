<template>
  <br><h1><center>Flash Sale</center></h1>
      <br><div style="background-color: rgb(202, 202, 202);" class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
